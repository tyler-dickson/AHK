...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375, v.2.13.BETA    ; change to 1.23.2017 when released
Gui, 1:Font
...
Gui, 1:Tab, 3
Gui, 1:Add, GroupBox, x5 y30 w290 h75,
Gui, 1:Add, Checkbox, cBlue x10 y30 Checked%Checkboxes7% vOption7, Enable EFS Options (!ATY in EFS + Settings Drawer.) 
...
IniWrite, v2.13.BETA, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, Version, Version
...
if Option7 = 1
	...
	Gui, 20: Add, Button, x%ScreenWidthPointFive% w%ScreenWidthFourPercent% gFillEFS, Fill EFS Sections
...
WinWait, Drawer
	Loop 10
		{
		Loops := ScreenWidthMinusFivePercent + (A_Index * ScreenWidthPointFive)
...
CloseDrawer:
	...
	Loop 14
	{
	Loops2 := 0 - (A_Index * ScreenWidthPointFive)
	WinMove, %Loops2%, 0
	}
	Sleep 200
	PosFound = 0
...
Gui, 99: Show, x%ScreenWidth% y%HalfScreenHeight% w%ScreenWidthSixteenPercent%, Copy Clipboard Slots
...
Loop 16
{
CopyLoops := ScreenWidth - (A_Index * ScreenWidthOnePercent)
WinMove, Copy Clipboard Slots, ,%CopyLoops%, HalfScreenHeight
}
Sleep 500
return
}
...
Loop 19
{
CopyLoops2 := CopyLoops + (A_Index * ScreenWidthOnePercent)
WinMove, Copy Clipboard Slots, ,%CopyLoops2%, HalfScreenHeight
}
Sleep 200
return
...
Gui, 99: +ToolWindow -Caption  ; Removes the Border and Task bar icon
Gui, 99: Show, x%ScreenWidth% y%HalfScreenHeight% w%ScreenWidthSixteenPercent%, Multiple Clipboard Slots
...
;MsgBox, %X% %Y%
	...
	if (X > ScreenWidthMinus5 &&  Y > ScreenHeightMinus5 && PosFound2 = 0 && IsCtrlDown = "D")
		...
		Loop 16
			{
			PasteLoops := ScreenWidth - (A_Index * ScreenWidthOnePercent )
			WinMove, Multiple Clipboard Slots, ,%PasteLoops%, HalfScreenHeight
			}
			Sleep 1000
			return
		;SetTimer, OpenDrawer, Off
...
if (X > ScreenWidthMinus5 &&  Y > ScreenHeightMinus5 && PosFound2 = 1 && IsCtrlDown = "D")
	{
	PosFound2 = 0
...
Loop 19
{
PasteLoops2 := PasteLoops + (A_Index * ScreenWidthOnePercent)
WinMove, Multiple Clipboard Slots, ,%PasteLoops2%, HalfScreenHeight
}
Sleep 200
gosub PasteDrawer
return
...
Gui, 99:  Add, Button, x%ScreenWidthPointFive%  w%ScreenWidthFifteenPercent% Wrap h30, Here are some suggested remarks:
Gui, 99:  Font, s10 w500, Verdana
...
Gui, 99: Font
Gui, 99: +ToolWindow -Caption  ; Removes the Border and Task bar icon
Gui, 99: Show, x%ScreenWidth% y%HalfScreenHeight% w%ScreenWidthSixteenPercent%, Suggested Remarks
Sleep 150
...
Loop 16
{
SuggestionLoops := ScreenWidth - (A_Index * ScreenWidthOnePercent)
WinMove, Suggested Remarks, ,%SuggestionLoops%, HalfScreenHeight
}
Sleep 500
return
}
...
Loop 19
{
SuggestionLoops2 := SuggestionLoops + (A_Index * ScreenWidthOnePercent)
WinMove, Suggested Remarks, ,%SuggestionLoops2%, HalfScreenHeight
}
Sleep 200
gosub PasteDrawer
return	
