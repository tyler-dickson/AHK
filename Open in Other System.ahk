...
+CapsLock::
UserID = -TDICKSON
formattime, carrotcake, , MM/dd/yyyy  
  send %carrotcake%      
Send {Space}-{Space}
...
^`::
	...
	WinGetClass, sClass, A
        ...
        AppString = ;
        FrontString = ;
        ;PatentString = https://autohotkey.com                                                   ; Prefix section of a Live Patent for testing (22 Characters).
        ;TMString = https://www.facebook.com                                                     ; Prefix section of a Live Trademark for testing (25 Characters).
		...
		{
                SplashTextOn, 300,,Unable to determine URL. Not in a browser window.,
                Sleep 1000
                SplashTextOff
                Return
                } 
	Else
		{
                SplashTextOn, 300,,No link to open. Not in a browser window.,
                Sleep 1000
                SplashTextOff
                Return
                }
