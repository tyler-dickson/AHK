...
EmailBodyContents := "<HTML><style> table {border-style: solid; border-collapse:collapse; border-width: 1px;} td {border-style: solid; border-collapse:collapse; border-width: 1px; text-align: center; vertical-align: middle; padding: 5px;} p{color: blue;} h3{color: red;} <BODY><p>Docketing requires an update on the following items from your holiday docket during the date range in the Subject line.<h3> If you will be out during the holiday period, please provide us with the name of the attorney/paralegal who will be handling your date(s).</h3><p>For <b>EP/CN</b> actions, please advise if you will be utilizing the grace period.<br><br>Please provide an update to <u>*--INTDATES</u> as soon as possible.</style></p><table><tr><td align=center valign=middle>" DueDate "</td><td align=center valign=middle>" ActionType "</td><td align=center valign=middle>" ActionDue "</td><td align=center valign=middle>" Indicator "</td><td align=center valign=middle>" ClientCode "</td><td align=center valign=middle>" Responsible "</td></tr>"
MailItem.To := EmailAddress 
EmailSubject := "RESPONSE REQUIRED - " Responsible " | " DateRange " Holiday Docket Items Requiring Immediate Response"
StringReplace, EmailSubject, EmailSubject, `r, , A
MailItem.Subject := EmailSubject ;change to whatever your subject is.
	if ((Responsible = "DJF") || (Responsible = "MBH") || (Responsible = "RJR") || (Responsible = "TYY") || (Responsible = "BJJ") || (Responsible = "ZJH"))
