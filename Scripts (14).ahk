...
IniWrite, v3.1.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
...
PasteClipboards:
IniRead, WindowClose, C:\Users\%A_Username%\AHKPrefs.ini, Username, WindowClose
...
GuiControlGet, HideWindow, , Button8
	if HideWindow = 0
		...
		IniWrite, %WindowClose%, C:\Users\%A_Username%\AHKPrefs.ini, Username, WindowClose
		IniWrite, %WindowPosX%, C:\Users\%A_Username%\AHKPrefs.ini, Username, WindowPosX
		IniWrite, %WindowPosY%, C:\Users\%A_Username%\AHKPrefs.ini, Username, WindowPosY		
		return
		}
