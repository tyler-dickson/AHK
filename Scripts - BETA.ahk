...
Sleep 200
Gui, 1: New, +AlwaysOnTop +Owner, Settings Menu
Gui, Add, Tab3, x1 y0 w300 h390 +Center, Settings|Custom Options|EFS Options|Keybindings ;
...
Gui, 1: Font, s12 bold underline
Gui, 1: Add, Text,x0 y22 w300 h36 +Center, Settings Menu
Gui, 1: Font
Gui, 1: Font, s6
Gui, 1: Add, Text, x260 y0, v.1.11.2017
Gui, 1: Font
...
Gui, 1:Font
Gui, 1:Add, Text, x5 y22 w145 +Center,Record Opener Options:
Gui, 1:Font
Gui, 1:Add, Text, x2 y40 w70 +Center,Patent:
Gui, 1:Add, Text, x2 y60 w70 +Center,Trademark:
Gui, 1:Add, Text, x2 y80 w70 +Center,Invention:
Gui, 1:Add, Checkbox, x90 y40  Checked%RecordBoxes1% gClearA vRecordBox1, Live
Gui, 1:Add, Checkbox, x133 y40  Checked%RecordBoxes2% gClearB vRecordBox2, AT
Gui, 1:Add, Checkbox, x90 y60 Checked%RecordBoxes5% gClearC vRecordBox5, Live
Gui, 1:Add, Checkbox, x133 y60 Checked%RecordBoxes6% gClearD vRecordBox6, AT
Gui, 1:Add, Checkbox, x90 y80 Checked%RecordBoxes3% gClearE vRecordBox3, Live
Gui, 1:Add, Checkbox, x133 y80 Checked%RecordBoxes4% gClearF vRecordBox4, AT
Gui, 1:Font, bold 
Gui, 1:Add, Text, x5 y103 w145 +Center, Force Only Patent/TM?
Gui, 1:Font
Gui, 1:Font, italic
Gui, 1:Add, Text, x5 y118 w145 +Center, No pop-up or AT option.
Gui, 1:Font
Gui, 1:Add, Radio, x2 y135 h20 w32          Checked%RadioChoice1% vRadioChoice1, Off
Gui, 1:Add, Radio, x35 y135 h20 w48 gClear1 Checked%RadioChoice2% vRadioChoice2, Patent
Gui, 1:Add, Radio, x85 y135 h20 w70 gClear2 Checked%RadioChoice3% vRadioChoice3, Trademark
;Gui, 1:Add, Button, x264 y0 w35 h35 gPopEFSButton,EFS Fill
...
Gui, Tab, 3
Gui, 1: Font, s6 bold
Gui, 1: Add, Text, x3 y25 w5 h17 gHelp6, ?
Gui, 1: Font
Gui, 1: Add, Checkbox, x13 y25 Checked%Checkboxes7% gShowEFSButton vOption7, EFS Cert/Password Finder + EFS Fill/Fees Login
Gui, 1: Add, Button, x264 y25 w35 h35 gPopEFSButton,EFS Fill
Gui, 1:Add, Text, x153 h20 y120  w146 +Center, First Name:
Gui, 1:Add, Edit, x153 h20 y135  w146 Limit +Center vEFSFirst, %EFSFirst%
Gui, 1:Add, Text, x153 h20 y160  w146 +Center, Last Name:
Gui, 1:Add, Edit, x153 h20 y175  w146 Limit +Center vEFSLast, %EFSLast%
Gui, 1:Add, Text, x153 h20 y200 w146 +Center, Filing Email Address:
	if EFSEmail = instructions@knobbe.com
		Gui, 1:Add, DropDownList, R2 x153 h20 y215 w146 +Center vEFSEmail, %EFSEmail%||efiling@knobbe.com
	else if EFSEmail = efiling@knobbe.com
		Gui, 1:Add, DropDownList, R2 x153 h20 y215 w146 +Center vEFSEmail, %EFSEmail%||instructions@knobbe.com
Gui, 1:Add, Text, x153 h20 y240 w146 +Center, Fees Email/Username:
Gui, 1:Add, Edit, x153 h20 y255 w146 +Center vEFSPayEmail, %EFSPayEmail%
Gui, 1:Add, Text, x153 h20 y280 w146 +Center, Fees Payment Password:
Gui, 1:Add, Edit, x153 h20 y295 w146 +Center Password vEFSPayPassword, %EFSPayPassword%
...
ClearA:
GuiControl, 1: , Button7, 1
GuiControl, 1: , Button8, 0
GuiControl, 1: , Button9, 0
return
...
Clear1:
GuiControl, 1: , Button1, 0
GuiControl, 1: , Button2, 0
GuiControl, 1: , Button3, 0
GuiControl, 1: , Button4, 0
GuiControl, 1: , Button5, 0
...
IniWrite, v1.11.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, Version, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
