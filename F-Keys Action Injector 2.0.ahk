...
Sleep 200
ActionType := ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value  ; GRAB value
; ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").focus()  ; GRAB value
; ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").blur()  ; GRAB value
...
if ActionType = %Temp1%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp2
else if ActionType = %Temp2%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp3
else if ActionType = %Temp3%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp4
else if ActionType = %Temp4%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp5
else if ActionType = %Temp5%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp6
else if ActionType = %Temp6%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp7
else if ActionType = %Temp7%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp8
else if ActionType = %Temp8%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp9
else if ActionType = %Temp9%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp10
else if ActionType = %Temp10%
	ie.document.getElementByID("ctl00_Detail_tplFormview_ActionType_Input").value := Temp1
