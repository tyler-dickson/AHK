...
MsgBox, Username is %A_Username%. Computername is %Computername%.
...
Gui, Add, Button, gShowSignature   xp yp+80 wp hp, Saved Signature
Gui, Add, Button, gCreateEmails    xp yp+80 wp hp, Create Emails
...
MsgBox, Am I connected to Excel?`n`n1 = Yes`, 0 = No`n`n%TrueOrFalse%
...
MsgBox, %FaceAtty0% lines selected.
...
MsgBox, I should be looping now. %A_Index% times so far.
