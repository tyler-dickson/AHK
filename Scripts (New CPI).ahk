...
Gui, 1: New, AlwaysOnTop ToolWindow,
...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375 gCherSystemSwitch vCherSystemSwitch, v.4.2.2021   ; Version: change to 1.23.2017 when released
Gui, 1:Font 
...
Gui, 1: Tab
Gui, 1:Add, Edit, ReadOnly h50 w300 x0 y470, Update Notes 4/2/2021: Miscellaneous updates.
...
Gui, 1: Show, h520 w300, Docketing Scripts (New CPI)    ;h390 w300
...
IniWrite, v.4.2.2021, \\docs-oc\files\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
