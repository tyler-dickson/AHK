...
StringSplit, Columns, SavedContent%A_Index%, `t
	ifMsgBox Yes
		CleanedColumns = % Columns1 "`t"  Columns3 "`t" Columns6 . "." . Columns7      ; Columns6 "`t" Columns7
	ifMsgBox No
		CleanedColumns = % Columns1 "`t"  Columns6 . "." . Columns7                    ; Columns6 "`t" Columns7
