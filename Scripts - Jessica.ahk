...
Gui, 1: Font, s6
Gui, 1: Add, Text, x260 y0, v.1.6.2017
Gui, 1: Font
...
Gui, 1: Add, Checkbox, x10 Checked%Checkboxes8% vOption8, Open Hyperlink from Excel (Facing, Past Due)
...
Gui, 1: Add, Checkbox, x10 Checked%Checkboxes9% vOption9 , Custom SideBar
	if CustomSideBar = ;
		Gui, 1: Add, ComboBox, Sort R20 x112 y320 w175 h18 +Center vCustomSideBar, calc.exe||www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboards|Store Clipboards|Quick Date and Initials|Hyperlink from Excel|System Switch|Quick Today's Date|
	else
		Gui, 1: Add, ComboBox, Sort R20 x112 y320 w175 h18 +Center vCustomSideBar, %CustomSideBar%||www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboards|Store Clipboards|Quick Date and Initials|Hyperlink from Excel|System Switch|Quick Today's Date|
Gui, 1: Font, bold
...
if StatusButton10 = 0
	GuiControl, 1: Hide , Button15
if StatusButton10 = 1
	GuiControl, 1: Show , Button15	
return
...
IniWrite, Version-1.6.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Jessica.Egigian.ini, Jessica.Egigian, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
