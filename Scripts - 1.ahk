...
Gui, 1: Font
Gui, 1: Font, s6
Gui, 1: Add, Text, x260 y0, v.1.9.2017
Gui, 1: Font
...
IniWrite, Version-1.9.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, %A_Username%, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
...
EFSFill:
OutputVar = http://oc-metastorm/Metastorm/eactionformcontents.ashx?Action=Query+by+content&Map=Search for Folder&Timestamp=2017-01-09T16:32:18&Service=Metastorm+BPM+Server&CancelURL=eWorkCloseWindow&LaunchURL=eWorkCloseWindow
if  hWnd :=  WinExist("ahk_class IEFrame")
{
   For ie in ComObjCreate("Shell.Application").Windows
   {} Until  (hWnd = ie.hwnd)
...
Remarks := ie.Document.All.trademark_GoodsServClassNo.Value
MsgBox, %Remarks%
