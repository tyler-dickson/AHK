...
UpdateStatus =
(
UPDATE NOTES | 10/6/2020
-Lara wanted DocketMods to remember your choices, 
so I walked her through how to do it and updated the script.
	-If it messes up, you can blame her!
)

Gui, New, , LA AHK MODS PRACTICE SCRIPT
...
AddActionSlots:
WinGetPos, , , GuiWidth, GuiHeight, DocketMods Settings
...
id="sendFeedback" value="Feedback" value1="0" href="#"  onMouseOut="this.style.color='000000'" onMouseOver="this.style.color='ff0000'" onclick="window.open('mailto:tyler.dickson@knobbe.com&subject=DocketMods&nbsp;Feedback');">Feedback</a>
...
if ComputerName = tyler.dickson
	...
	right_Button5 =		<td title="Nothing." style="height: 100`%; width: 150px; text-align:center; border:0px solid black; padding: 0px;"><button style="height:50px; width:100px; color:%TextColor%; background-color:%CustomColor%; cursor:crosshair;" id="" value1="0" onclick="this.value1 = '1';" onMouseOut="this.style.backgroundColor='%CustomColor%'; this.style.color='%TextColor%'" onMouseOver="this.style.backgroundColor='%HoverColor%'; this.style.color='red'" >Nothing.</button></td>
...
; ifinstring, location, docketing
	...
	;	document.getElementById("fldstrAppTitle").addEventListener("click", function() {alert();}, false)
		...
		;		ie.document.getElementsByTagName("I")[0].style.backgroundColor := "red"
			...
			Temp := ie.document.getElementById("fldstrActionType_TextBox").value
			if Temp = 		
				ie.document.getElementById("fldstrActionType_TextBox").value := "INT-PAT STATUS CHECK"
			else if Temp = INT-PAT STATUS CHECK
