...
Cell := xl.ActiveCell.Value
StringSplit, NewCell, Cell, |
ie.Navigate(NewCell1)
while ie.busy or ie.ReadyState != 4 ;Wait for page to load
	Sleep, 100
ie.document.getElementById("fldstrActionType_TextBox").value := "INT-TM AR DECLARATION OF USE"
ie.document.getElementById("flddteBaseDate").value := NewCell2
Sleep 500
