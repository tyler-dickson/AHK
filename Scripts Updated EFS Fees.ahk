...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375 gCherSystemSwitch vCherSystemSwitch, v.10.11.2018   ; Version: change to 1.23.2017 when released
Gui, 1:Font
...
Gui, 1: Tab
Gui, 1:Add, Edit, ReadOnly h60 w300 x0 y390, UPDATE 10/1/2018:`n-Figured out a different way to use EFS Fee Login.`n`tContact me for details if you use it.
...
IniWrite, v.10.11.2018, \\docs-oc\files\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
...
::!BJJ::
global AttyCert := "\\docs-sf\files\USPTO\Bryan.Johnson.epf"
gosub, GetPassword
return

::!ADL::
global AttyCert := "\\docs-oc\files\USPTO\Andrew.Lee.epf"
gosub, GetPassword
return

::!CZB::
global AttyCert := "\\docs-sd\files\USPTO\Caleb.Bates.epf"
gosub, GetPassword
return

::!CZH::
global AttyCert := "\\docs-sd\files\USPTO\Clayton.Henson.epf"
gosub, GetPassword
return
...
Gui, 2: Add, Button, x4    y50 	   w33 gAdd1Wnew, +1W
