...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375 gCherSystemSwitch vCherSystemSwitch, v.5.17.2018   ; Version: change to 1.23.2017 when released
Gui, 1:Font
...
Gui, 1: Tab
Gui, 1:Add, Edit, ReadOnly h60 w300 x0 y390, UPDATE 4/27/2018:`n-Updated System Switch to work on Quick Docket links and Invention Screen.`n
...
IniWrite, v.5.17.2018, \\docs-oc\files\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
