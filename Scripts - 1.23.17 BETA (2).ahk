...
Gui, 21: Other Drawer Bottom Left Corner
...
global ScreenWidthPlus420 := ScreenWidth + 420
global ThirdScreenHeight := A_ScreenHeight * .33
global HalfScreenHeight  := A_ScreenHeight * .5
global TwoThirdScreenHeight := A_ScreenHeight * .67			  
...
Gui, 1: Add, Tab3, x1 y0 w300 h390 +Center, Misc.|Multiuse|EFS/Hotstring/SideBar|Keybindings| ;
Gui, 1: Tab, 1
...
Gui, 1:Add, Checkbox, cBlue x10 y122 Checked%Checkboxes4% gDisable2 vOption4, Enable System Switch Shortcut
Gui, 1:Font, italic
...
Gui, 1:Add, Checkbox, cBlue x10 y170  Checked%Checkboxes5% vOption5, Enable Settings/Shortcuts Bar
Gui, 1:Font, Italic
...
Gui, 1:Add, Checkbox, cBlue x10 y244 Checked%Checkboxes6% gDisable3 vOption6, Enable Store/Paste Extra Clipboards
Gui, 1:Font, Italic
Gui, 1:Add, Text, x10 y264 w270 +Center, *See Help section for detailed usage instructions.*
Gui, 1:Font

Gui, 1:Add, GroupBox, x5 y293 w290 h50, 
Gui, 1:Add, Checkbox, cBlue x10 y293 Checked%Checkboxes8% gDisable4 vOption8, Enable Open Hyperlink from Excel
Gui, 1:Font, Italic
...
Gui, 1: Font, s6
Gui, 1: Add, Text, x255 h10 y375, v.1.23.BETA    ; change to 1.23.2017 when released
Gui, 1: Font
...
Gui, 1: Tab, 3
Gui, 1:Add, GroupBox, x5 y30 w290 h75,
Gui, 1:Add, Checkbox, cBlue x10 y30 Checked%Checkboxes7% vOption7, Enable EFS Options (!ATY in EFS + Pop-out Menu.) 
...
Gui, 1:Add, GroupBox, cGreen  x5 y260 w290 h50, Hotstrings Options (If present on Desktop.)
Gui, 1:Add, Button, gHotstringIt x10 y280 w80 h25, Start Script
Gui, 1:Add, Button, gHotstringIt2 x95 y280 w105 h25, Add New Hotstring
Gui, 1:Add, Button, gHotstringIt3 x205 y280 w85 h25, Correct Errors
			...
			ifMsgBox Yes
				...
				Sleep 200
					IfExist, C:\Users\%A_Username%\Desktop\Hotstrings.ahk
						...
						MsgBox, ,Something went wrong. I don't think it worked. Do you have the H: drive mapped? Try again, or add the Hotstrings.ahk script directly to your desktop.
				return
				}
			ifMsgBox No
				{
...
HotstringIt2:
	IfExist, C:\Users\%A_Username%\Desktop\Hotstrings.ahk
		...
		MsgBox, Hotstrings.ahk is not present on Desktop.`n`nDrag a copy from the H: drive to your desktop and try again.
return
...
IniWrite, v1.23.BETA, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, Version, Version
...
PopEFSButton:
SplashTextOn, 650, , This is automatically in the top-left corner now. Click Update`, then move your mouse to top-left corner of screen.
Sleep 3500
SplashTextOff
return
...
Gui, 20: Add, Picture, x0 y0 w120, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\HelpImages\top-left.png ;location of gif you want to show
Gui, 20: Add, Button, x20 w80 gdSettings, Settings
Gui, 20: Add, Button, x20 w80 h80 gCalculator, Open Calculator
Gui, 20: Add, Button, x20 w80 h80 gInternetExplorer, Open Internet Explorer
Gui, 20: Add, Button, x20 w80 h80 gGoogle, Open Google
Gui, 20: Add, Text, x0 w120 +Center , -------------`nThis is just some separator text.`n-------------
Gui, 20: Add, Button, x10 w100 gMapIt2, Run MapIt!
Gui, 20: Add, Button, x10 w100 gFillEFS, Fill EFS Sections
Gui, 20: Add, Button, x10 w100 gEFSPayLogIn, Log into EFS Fees
Gui, 20: Add, Button, x10 w100 gPasteClipboard, Paste Clipboard
Gui, 20: +ToolWindow -Caption
Gui, 20: Color, ABCEDF
Gui, 20: Show, x-120 y0 w120 h510

SetTimer, OpenDrawer, 200
return

IndicatorDrawer:             ; This is just for the example bouncing drawer. Disable later.
WinWait, Drawer
	Loop 12
		{
		Loops := -120 + (A_Index * 10)
		WinMove, Drawer, ,%Loops%, 0
		}
Sleep 1500
gosub CloseDrawer
Sleep 1000
...
;MsgBox, %X% %Y%
	;if (X > 2550 && Y > 100 && Y < 500 && PosFound = 0)
...
if Slots = XXX01010
	{
	Gui, 10:Add, Button, x%Slot1X% y0 w100 h20 gCustomBut6, Fill EFS Sections		 ;Quick link to Fill EFS Sections
	Gui, 11:Add, Button, x%Slot1X% y0 w100 h20, Fill EFS Sections			 ;Quick link to Fill EFS Sections	
	}
if Slots = XXX01011
	{
	Gui, 10:Add, Button, x%Slot1X% y0 w100 h20 gCustomBut5, Excel Hyperlink	 ;Option 8 - ^1 - Open Excel Hyperlink
	Gui, 11:Add, Button, x%Slot1X% y0 w100 h20, Excel Hyperlink		 ;Option 8 - ^1 - Open Excel Hyperlink	
	Gui, 10:Add, Button, x%Slot2X% y0 w100 h20 gCustomBut6, Fill EFS Sections		 ;Quick link to Fill EFS Sections
	Gui, 11:Add, Button, x%Slot2X% y0 w100 h20, Fill EFS Sections			 ;Quick link to Fill EFS Sections	
	}
if Slots = XXX01100
	{
...
if Slots = XXX01110
	...
	Gui, 10:Add, Button, x%Slot2X% y0 w100 h20 gCustomBut4, Paste++          ;Option 6 - ^6 - Paste Extra Clipboards
	Gui, 11:Add, Button, x%Slot2X% y0 w100 h20, Paste++                      ;Option 6 - ^6 - Paste Extra Clipboards
	Gui, 10:Add, Button, x%Slot3X% y0 w100 h20 gCustomBut6, Fill EFS Sections		 ;Quick link to Fill EFS Sections
	Gui, 11:Add, Button, x%Slot3X% y0 w100 h20, Fill EFS Sections			 ;Quick link to Fill EFS Sections	
	}
if Slots = XXX01111
	{
	Gui, 10:Add, Button, x%Slot1X% y0 w100 h20 gCustomBut3, Copy++		 ;Option 6 - ^5 - Copy Extra Clipboards
	...
	Gui, 10:Add, Button, x%Slot3X% y0 w100 h20 gCustomBut5, Excel Hyperlink	 ;Option 8 - ^1 - Open Excel Hyperlink
	Gui, 11:Add, Button, x%Slot3X% y0 w100 h20, Excel Hyperlink		 ;Option 8 - ^1 - Open Excel Hyperlink	
	Gui, 10:Add, Button, x%Slot4X% y0 w100 h20 gCustomBut6, Fill EFS Sections		 ;Quick link to Fill EFS Sections
	Gui, 11:Add, Button, x%Slot4X% y0 w100 h20, Fill EFS Sections			 ;Quick link to Fill EFS Sections	
	}
if Slots = XXX11000
	{
...
if Slots = XXX11111
	...
	Gui, 10:Add, Button, x%Slot4X% y0 w100 h20 gCustomBut5, Excel Hyperlink	 ;Option 8 - ^1 - Open Excel Hyperlink
	Gui, 11:Add, Button, x%Slot4X% y0 w100 h20, Excel Hyperlink		         ;Option 8 - ^1 - Open Excel Hyperlink	
	Gui, 10:Add, Button, x%Slot5X% y0 w100 h20 gCustomBut6, Fill EFS Sections			 ;Quick link to Fill EFS Sections
	Gui, 11:Add, Button, x%Slot5X% y0 w100 h20, Fill EFS Sections			             ;Quick link to Fill EFS Sections	
	}
...
Gui, 99: Add, Button, x10 w400 h30, Where would you like to store the text?
Gui, 99: Font, s10 w500, Verdana
Gui, 99: Add, Button, x10 w400 Wrap gBut1, %Clip1%
Gui, 99: Add, Button, x10 w400 Wrap gBut2, %Clip2%
Gui, 99: Add, Button, x10 w400 Wrap gBut3, %Clip3%
Gui, 99: Add, Button, x10 w400 Wrap gBut4, %Clip4%
Gui, 99: Add, Button, x10 w400 Wrap gBut5, %Clip5%
Gui, 99: Font, s12 bold, Verdana
Gui, 99: Add, Button, x10 gBut6, Cancel
Gui, 99: +ToolWindow -Caption  ; Removes the Border and Task bar icon
Gui, 99: Show, x%ScreenWidthPlus420% y%TwoThirdScreenHeight% w420, Copy Clipboard Slots
gosub OpenCopyDrawer
return 
 
OpenCopyDrawer:
;	IfWinActive, ,Multiple Clipboard Slots
;		gosub ClosePasteDrawer
global CopyLoops
global CopyLoops2
CoordMode, Mouse, Screen
GetKeyState, IsCtrlDown, Control
WinWait, Copy Clipboard Slots
Loop 21
{
CopyLoops := ScreenWidth - (A_Index * 20)
WinMove, Copy Clipboard Slots, ,%CopyLoops%, TwoThirdScreenHeight
}
Sleep 500
return
...
Loop 21
{
CopyLoops2 := CopyLoops + (A_Index * 20)
WinMove, Copy Clipboard Slots, ,%CopyLoops2%, TwoThirdScreenHeight
}
Sleep 200
return
...
Gui, 99: Font, s12 bold, Verdana
Gui, 99: Add, Button, x10 w400 h30, What would you like to paste?
Gui, 99: Font, s10 w500, Verdana
Gui, 99: Add, Button, x10 w400 Wrap gPaste1, %Clip1%
Gui, 99: Add, Button, x10 w400 Wrap gPaste2, %Clip2%
Gui, 99: Add, Button, x10 w400 Wrap gPaste3, %Clip3%
Gui, 99: Add, Button, x10 w400 Wrap gPaste4, %Clip4%
Gui, 99: Add, Button, x10 w400 Wrap gPaste5, %Clip5%
Gui, 99: Font, s12 bold, Verdana
Gui, 99: Add, Button, x10 gPaste6, Cancel
Gui, 99: +ToolWindow -Caption  ; Removes the Border and Task bar icon
Gui, 99: Show, x%ScreenWidthPlus420% y%TwoThirdScreenHeight% w420, Multiple Clipboard Slots
;Gui, 98: Color, 000111 ; can be any colour but it's good to use a color that is NOT present in ur GUI
;Gui, 98: Show, , Multiple Clipboard Slots
;WinSet, Transcolor, 000111, Multiple Clipboard Slots
SetTimer, OpenPasteDrawer, 200
return
...
;MsgBox, %X% %Y%
	;if (X > 2550 && Y > 100 && Y < 500 && PosFound = 0)
	if (X > ScreenWidthMinus5 &&  Y > ScreenHeightMinus5 && PosFound2 = 0 && IsCtrlDown = "D")
		{
		;Gui, 99: Destroy
		;Gui, 97: Destroy
		PosFound2 = 1
		WinWait, Multiple Clipboard Slots
		Loop 21
			{
			PasteLoops := ScreenWidth - (A_Index * 20)
			WinMove, Multiple Clipboard Slots, ,%PasteLoops%, TwoThirdScreenHeight
			}
			Sleep 1000
			return
		;SetTimer, OpenDrawer, Off
		}
	else if (X > ScreenWidthMinus5 &&  Y > ScreenHeightMinus5 && PosFound2 = 1 && IsCtrlDown = "D")
		{
		PosFound2 = 0
		gosub ClosePasteDrawer
		}
...
Loop 21
{
PasteLoops2 := PasteLoops + (A_Index * 20)
WinMove, Multiple Clipboard Slots, ,%PasteLoops2%, TwoThirdScreenHeight
}
Sleep 200
gosub PasteDrawer
return
...
[Actions]
INT-PAT STATUS CHECK=PATENT 1|PATENT 2|PATENT 3|This is a really long one. Let's see how it handles it. OK, I'm talking really long.|
INT-TM STATUS ACTION=TRADEMARK 1|TRADEMARK 2|TRADEMARK 3|TRADEMARK 4|TRADEMARK 5
...
IniRead, CopiedAction, C:\Users\tbone\Desktop\Scripts - 1.23.17 BETA.ahk, Actions, %CopiedAction%
Sleep 100
...
Gui, 99:  Add, Button, x10 w400 Wrap h30, Here are some suggested remarks:
Gui, 99:  Font, s10 w500, Verdana
Gui, 99:  Add, Button, x10 w400 Wrap gArray1, % Array[1]
if % Array[2] = ""{
}
else  
     Gui, 99: Add, Button, x10 w400 Wrap gArray2, % Array[2] 
if % Array[3] = ""{
}
else	 
     Gui, 99: Add, Button, x10 w400 Wrap gArray3, % Array[3]
if % Array[4] = ""{
}
else	 
     Gui, 99: Add, Button, x10 w400 Wrap gArray4, % Array[4]
if % Array[5] = ""{
}
else	
Gui, 99: Add, Button, x10 w400 Wrap gArray5, % Array[5] 
Gui, 99: Font, s12 bold, Verdana 
Gui, 99: Add, Button, x10 gArray6, Cancel
Gui, 99: Font
Gui, 99: +ToolWindow -Caption  ; Removes the Border and Task bar icon
Gui, 99: Show, x%ScreenWidthPlus420% y%TwoThirdScreenHeight% w420, Suggested Remarks
Sleep 150
gosub OpenSuggestionDrawer
Return 
}
}
	
OpenSuggestionDrawer:
global SuggestionLoops
global SuggestionLoops2
CoordMode, Mouse, Screen
WinWait, Suggested Remarks
Loop 21
{
SuggestionLoops := ScreenWidth - (A_Index * 20)
WinMove, Suggested Remarks, ,%SuggestionLoops%, TwoThirdScreenHeight
}
Sleep 500
return
...
Loop 21
{
SuggestionLoops2 := SuggestionLoops + (A_Index * 20)
WinMove, Suggested Remarks, ,%SuggestionLoops2%, TwoThirdScreenHeight
}
Sleep 200
gosub PasteDrawer
return	
...
if (xpos > 2150) & (ypos > 800)     
     ...
     Gui, +ToolWindow -Caption  ; Removes the Border and Task bar icon
	 Gui, Color, 000111 ; can be any colour but it's good to use a color that is NOT present in ur GUI
	 Gui, Show, , Remarks Suggestions
	 WinSet, Transcolor, 000111, Remarks Suggestions
	 Return  
     }
else if (ypos > 800)     
     {
