...
Gui, Font, s12
Gui, Add, Button, gGrabFacingInfo  xp+655 yp w150 h35, Grab Facing Info
Gui, Add, Button, gClearFacingInfo xp yp+40 wp hp, Clear Facing Info
Gui, Add, Button, gCreateEmails    xp yp+225 wp hp, Create Emails
...
Gui, Signature: Show
Run "H:\Docketing\AutoHotKey\Test.gif"
return
...
EmailBodyContents := "<HTML><style> table {border-style: solid; border-collapse:collapse; border-width: 1px;} td {border-style: solid; border-collapse:collapse; border-width: 1px; text-align: center; vertical-align: middle; padding: 5px;} p{color: blue;} </style><p><BODY><p>Please take note of the following actions coming due on your docket between now and the end of the Independence Day holiday period.  Please provide an update to Docketing.  If you will be away from the office, please advise who will be handling the action so that Docketing can follow up with that person.<br><br>For national phase filing deadlines, please provide a list of countries where applications are to be filed.<br><br>Thank you!</p><br><table><tr><td align=center valign=middle>" DueDate "</td><td align=center valign=middle>" ActionType "</td><td align=center valign=middle>" ActionDue "</td><td align=center valign=middle>" Indicator "</td><td align=center valign=middle>" ClientCode "</td><td align=center valign=middle>" Responsible "</td></tr>"
MailItem.To := EmailAddress 
EmailSubject := Responsible " | " DateRange " Special Holiday Docket (Early Report)"
...
IfEqual, OutputVarControl, Button1
	Help := "This grabs your Facing information directly from Excel.`n`nAfter clicking, you'll have five seconds to highlight your data in Excel.`nYou can also select your information prior to clicking the button.`n`nIf you've already grabbed some information,`nthis will append your new Facing information to the list.`n`nThis is helpful for first grabbing Patent information,`nand then grabbing the Trademark information."
