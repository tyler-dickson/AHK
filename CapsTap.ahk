...
Sleep 2500
TrayTip
Gui, QuickDocket: New, +Owner, QuickDocket
Gui, QuickDocket: Add, ActiveX, w500 h500 vie2, Shell.Explorer  ; The final parameter is the name of the ActiveX component.
ie2.Navigate("http://kmobnetold/outsidekmobnet/cid/cidold/ClientList.aspx")  ; This is specific to the web browser control.
;Gui, Show
Gui, QuickDocket: Hide
return

#F1::
Gui, QuickDocket: Show
return
...
CapsToggle := !CapsToggle
if CapsToggle 
	InputBox, StoredCaps, Temp Override CapsTap, Overrides Client Code Grab if not blank.`nDelete everything to function normally., , 260, 142
else
	{
	TrayTip, Override disabled., CapsTap will now grab Client Code. 
	StoredCaps := ""
	Sleep 2000
	TrayTip
	}
