...
Gui, Add, DropDownList, R5 x10 h20 y23 w140 +Center vNewStatus gNewStatus, ABA Intent|ABA Intent (Qualcomm)|Abandoned|Pend Tran|Transferred
Gui, Font, underline
...
Remarks := ie.document.getElementByID("fldstrRemarks").Value
	if ComboBox1Text = 
		{
		MsgBox, Choose a new Status in the top field if you want to close an action.
		Gui, Show
		return
		}
	if ComboBox1Text = ABA Intent
