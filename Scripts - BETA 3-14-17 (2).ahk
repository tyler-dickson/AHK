...
IniRead, HotCornerBL, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBL
	if HotCornerBL = ERROR
		{
		IniWrite, www.google.com , C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBL
		Sleep 100
		IniRead, HotCornerBL, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBL
		}		
IniRead, HotCornerTR, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerTR
	if HotCornerTR = ERROR
		{
		IniWrite, www.google.com , C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerTR
		Sleep 100
		IniRead, HotCornerTR, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerTR
		}		
IniRead, HotCornerBR, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBR
	if HotCornerBR = ERROR
		{
		IniWrite, www.google.com , C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBR
		Sleep 100
		IniRead, HotCornerBR, C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBR
		}		
...
;KeyWait, F5, D T0.20
;if ErrorLevel = 1
;	SendRaw INT-PAT POWER OF ATTORNEY REQUEST
;	SendRaw INT-PAT POWER OF ATTORNEY REQUEST NO DATE
;	SendRaw INT-TM POWER OF ATTORNEY REQUEST
;	SendRaw INT-TM POWER OF ATTORNEY REQUEST NO DATE
...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375, v.3.14.BETA   ; change to 1.23.2017 when released
Gui, 1:Font
...
IniRead, HotCornerBL,       C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBL
	if HotCornerBL = 0
		HotCornerBL = www.google.com
Gui, 1:Add, ComboBox,        Sort R20   x8 y273 w90 h16  vHotCornerBL, %HotCornerBL%|| |www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|


IniRead, HotCornerTR,       C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerTR
	if HotCornerTR = 0
		HotCornerTR = www.google.com
Gui, 1:Add, ComboBox,        Sort R20 x201 y246 w90 h16  vHotCornerTR, %HotCornerTR%|| |www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|

IniRead, HotCornerBR,       C:\Users\%Computername%\AHKPrefs.ini, Hotcorner, HotCornerBR
	if HotCornerBR = 0
		HotCornerBR = www.google.com
Gui, 1:Add, ComboBox,        Sort R20 x201 y273 w90 h16  vHotCornerBR, %HotCornerBR%|| |www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|
...
IniWrite, v3.14.BETA, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
...
else ifInString, SearchOnline, .
{
	StringLeft, SearchOnline, SearchOnline, 8
    Run % "https://register.epo.org/application?number=EP" SearchOnline
}
else
{
...
Gui, 20: Add, Text, Center x%ScreenWidthPointFive% w%ScreenWidthFourPercent% vgui_main_title, PCT App #`nor EP/Madrid App #
...
if NewClipboard = ;
	{
	TrayTip, Blank Clipboard., Please try again.
...
Gui, 99: Show, x%WindowPosX% y%WindowPosY% w%ScreenWidthSixteenPercent% NoActivate, Copy Clipboard Slots
return 
}
...
Gui, 99: +ToolWindow  ; Removes the Border and Task bar icon
Gui, 99: Color, %CustomColor%
Gui, 99: Show, x%WindowPosX% y%WindowPosY% w%ScreenWidthSixteenPercent% NoActivate, Paste Clipboard Slots
...
Gui, 99: Color, %CustomColor%
Gui, 99: +ToolWindow  ; Removes the Border and Task bar icon
Gui, 99: Show, x%WindowPosX% y%WindowPosY% w%ScreenWidthSixteenPercent% NoActivate, Suggested Remarks
return 
}
}
