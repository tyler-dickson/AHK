...
global SettingsY
global SidebarX
IniRead, CloseMsgForever, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 04262017 
	if (CloseMsgForever = "ERROR") || (CloseMsgForever = 0)
		MsgBox, 52, Small update., More message box suppression has been added.`n`n-The warning that appears when you open a document link from the Correspondence Log in Excel will now automatically close.`n`n-A similar warning for opening other iManage links will also automatically close.`n`nThat's all for now.`n`nClick YES to hide this message for forever.`nClick NO to see this the next time you open the script.
		IfMsgBox Yes
			{
			IniWrite, 1, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 04262017 
			goto Reopen
			}
		IfMsgBox No
			{
...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375, v.4.26.2017   ; change to 1.23.2017 when released
Gui, 1:Font
...
IniWrite, v.4.26.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
