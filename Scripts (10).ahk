...
IniWrite, Version-1.4.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, %A_Username%, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
...
Gui, 50:Add, Button, x0 y0 w3 h%SideBarHeight% gSideBar, 
Gui, 50:Show, x%SideBarPosX% y%SideBarPosY% w5 h1020
...
Gui, 50:Show, x%SideBarPosX% y%SideBarPosY% w5 h%SideBarHeight%
return
}
