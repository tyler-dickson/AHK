...
Gui, 1: Add, Checkbox, x30 Checked%Checkboxes1% vOption1, Auto-remarks on Calendar Extend?
Gui, 1: Font
Gui, 1: Add, Button,   x30 w14 h14 gHotkeyD , 
Gui, 1: Add, Text,   x47 y394, Change Record Opener Options
Gui, 1: Color, ABCDEF
...
Gui, 5:Color, ABCDEF
Gui, 5: Add, Text, x5 y5,Patent:
Gui, 5: Add, Text, x5 y25,TM:
Gui, 5: Add, Checkbox, x42 y5  Checked%RecordBoxes1% vRecordBox1, Live
Gui, 5: Add, Checkbox, x85 y5  Checked%RecordBoxes2% vRecordBox2, AT
Gui, 5: Add, Checkbox, x123 y5 Checked%RecordBoxes3% vRecordBox3, Invention Live
Gui, 5: Add, Checkbox, x215 y5 Checked%RecordBoxes4% vRecordBox4, Invention AT
Gui, 5: Add, Checkbox, x42 y25 Checked%RecordBoxes5% vRecordBox5, Live
Gui, 5: Add, Checkbox, x85 y25 Checked%RecordBoxes6% vRecordBox6, AT
...
IniWrite, Version-12.29.2016, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, %A_Username%, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
...
if NewClipboard = ;
	...
	MsgBox, Valid text not selected.`n`nValid options include:`n`na) block of Attorneys `nb) Action Type`nc) a date in Docketing`nd) a Client Code.
return
