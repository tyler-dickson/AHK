...
global SettingsY
global SidebarX
IniRead, CloseMsgForever, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 03222017 
	if (CloseMsgForever = "ERROR") || (CloseMsgForever = 0)
		MsgBox, 20, Trying something new..., Hi everyone!`n`nI thought I'd try something new today and put a small message here.`n`nYou'll only see this when you restart your script.`n`nI've added a script that will automatically close the message box that pops up after you edit a record or an action. A few of us have been testing it for the last couple of weeks, and it is pretty great.`n`nThe difference is subtle but noticeable.`n`nYou shouldn't have any issues, but let me know if you encounter any weirdness.`n`nClick YES to hide this message for forever.`nClick NO to see this the next time you open the script.
		IfMsgBox Yes
			{
			IniWrite, 1, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 03222017 
			goto Reopen
			}
		IfMsgBox No
			{
