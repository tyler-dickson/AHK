...
IniRead, Username, C:\Users\Paul.traska\Desktop\test.ini, Username, key 
...
Sleep 3000
SplashTextOff
FileAppend, "Open Shortcut Tips" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
...
FileAppend, "Store Extra Clipboard Items" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
...
if (xpos > 2150) & (ypos > 800)
	 ...
	 WinSet, Transcolor, 000111, Test
	 Return 
FileAppend, "Paste Extra Stored Clipboard" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
return
...
FileAppend, "Hotkey for Date and Initials" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
...
if (xpos > 2150) & (ypos > 800)
     ...
     Gui, Show, x%xpos% y%ypos%
FileAppend, "Select Username for Remarks" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
return

Done:
{
Gui, Destroy
IniWrite, %Username%, C:\Users\Paul.traska\Desktop\test.ini, Username, key
FileAppend, "Select Username for Remarks" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
}
...
if InStr(URLString, DocketingString)
	 ...
	 FileAppend, "Open Hyperlink from Excel - Failed" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
     Return
     }
else
     {
     ...
     SplashTextOff
     Clipboard = %oldClipboard%
	 FileAppend, "Open Hyperlink from Excel" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
     Return
     }
Return
...
if InStr(MyString, PatentString)
     ...
     SplashTextOff
     Clipboard = %OldClipboard%
	 FileAppend, "Open Opposite System - Failed" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
     Return
     }
...
AppString = ;
FrontString = ;
FileAppend, "Open Opposite System" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
...
IniRead, CopiedAction, C:\Users\Paul.traska\Desktop\test.ini, Actions, %CopiedAction%
IniRead, Username, C:\Users\Paul.traska\Desktop\test.ini, Username, key
Sleep 200
...
if % Array[1] == "ERROR"  OR (StringLen, CopiedAction > 50)
	 ...
	 SplashTextOff
	 FileAppend, "Suggested Remarks - Failed" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
	 Return
	 }	 
else 
     {
...
Clipboard = %PreviousClip%
FileAppend, "Suggested Remarks" opened by %Username% on %TimeStamp%.`n, C:\Users\Paul.traska\Desktop\test.ini
Return
}
...
FileAppend, ::%Hotstring%::%Extended%`n, C:\Users\Paul.traska\Desktop\Scripts.ahk
Reload
