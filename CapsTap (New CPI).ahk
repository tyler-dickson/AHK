...
Gui, New, ToolWindow, CapsTaps Customizer
Gui, Add, Radio, vRadioGroup Checked1, CapsLock
Gui, Add, Radio, , RControl
Gui, Add, Radio, , Insert
Gui, Add, Radio, , Pause
...
Gui, Submit
if (RadioGroup == "1")
	Hotkey, CapsLock,  Custom1,  On
else if (RadioGroup == "2")
	Hotkey, RControl,  Custom1,  On
else if (RadioGroup == "3")
	Hotkey, Insert,  Custom1,  On
else if (RadioGroup == "4")
	Hotkey, Pause,  Custom1,  On
else if (RadioGroup == "5")
	Hotkey, Printscreen,  Custom1,  On
else if (RadioGroup == "6")
	Hotkey, PgUp,  Custom1,  On
else if (RadioGroup == "7")
	Hotkey, PgDn,  Custom1,  On
return
...
IfWinActive, ahk_class XLMAIN
	...
	if InStr(newURL, "ActionDue")
		ClientCodeNew := Page.Evaluate("document.getElementById('ctl00_Detail_tplFormview_CaseNumber').value").Value
	else
		ClientCodeNew := Page.Evaluate("document.getElementById('ctl00_Detail_CaseNumber').value").Value
