...
Gui, 1: Font
Gui, 1: Font, s6
Gui, 1: Add, Text, x260 y0, v.1.10.2017
Gui, 1: Font
...
Gui, 1: Font,
Gui, 1: Add, Text, x0 y168 w300 Center, Control + CapsLock - Open Settings Menu
...
Gui, 1: Font
	...
	if CustomSideBar = ;
		Gui, 1: Add, ComboBox, Sort R20 x112 y320 w175 h18 +Center vCustomSideBar, calc.exe||www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboards|Copy Clipboards|Quick Date and Initials|Hyperlink from Excel|System Switch|Quick Today's Date|
	else
		Gui, 1: Add, ComboBox, Sort R20 x112 y320 w175 h18 +Center vCustomSideBar, %CustomSideBar%||www.google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboards|Copy Clipboards|Quick Date and Initials|Hyperlink from Excel|System Switch|Quick Today's Date|
Gui, 1: Font, s6 bold
...
IniWrite, v1.10.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Jessica.egigian.ini, Version, Version
Gui, 8:Destroy
Gui, 9:Destroy
Gui, 10:Destroy
Gui, 11:Destroy
