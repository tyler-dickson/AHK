...
The Quick Record Opener/EFS Section Filler Update - 1/2/2017
...
;MsgBox, Left %Mon1Left%`nRight %Mon1Right%`nTop %Mon1Top%`nBottom %Mon1Bottom%
RightSide  := Mon1Right - 3
BottomSide := Mon1Bottom - 70
Gui, 50:New, AlwaysOnTop Owner,SideBar
Gui, 50:Add, Button, x0 y0 w3 h%BottomSide% gSideBar, 
Gui, 50:Show, x%RightSide% y30 w5 h1400
