...
global SettingsY
global SidebarX
IniRead, CloseMsgForever, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 04042017 
	if (CloseMsgForever = "ERROR") || (CloseMsgForever = 0)
		MsgBox, 20, Small update., Just adding one small thing in this update.`n`n-The warning you receive when opening an iManage document will now automatically close and open the document. If you've had *Helpdesk untick the checkmark on the warning, or rarely open iManage attachments, you won't even notice the difference.`n`nClick YES to hide this message for forever.`nClick NO to see this the next time you open the script.
		IfMsgBox Yes
			{
			IniWrite, 1, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 04042017 
			goto Reopen
			}
		IfMsgBox No
			{
...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375, v.4.4.2017   ; change to 1.23.2017 when released
Gui, 1:Font
...
IniWrite, v.4.4.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
