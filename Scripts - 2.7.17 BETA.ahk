...
Gui, 1: Font, s6
Gui, 1: Add, Text, x255 h10 y375, v.2.7.BETA    ; change to 1.23.2017 when released
Gui, 1: Font
...
HotstringIt2:
	IfExist, C:\Users\%A_Username%\Desktop\Hotstrings.ahk
		...
		MsgBox, Hotstrings.ahk is not present on Desktop.`n`nAdd a copy from the H: drive to your desktop and try again.
return
...
IniWrite, v2.7.BETA, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%A_Username%.ini, Version, Version
...
PopEFSButton:
SplashTextOn, 650, , This is automatically in the top-left corner now. Click Update`, then hold Control and move your mouse to top-left corner of the screen.
Sleep 3500
SplashTextOff
return
...
Gui, 20: Add, Button, x20 w80 gPasteClipboard, Paste Clipboard
...
gosub OpenPasteDrawerHotkey   ;PasteClipboard: 
return
