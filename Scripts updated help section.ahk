...
global SidebarX
global RespAtty
IniRead, CloseMsgForever, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 07252017 
	if (CloseMsgForever = "ERROR") || (CloseMsgForever = 0)
		...
		IfMsgBox Yes
			{
			IniWrite, 1, C:\Users\%Computername%\AHKPrefs.ini, CloseMsgBox, 07252017  
			goto Reopen
			}
		IfMsgBox No
			{
...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375 gCherSystemSwitch vCherSystemSwitch, v.7.25.2017   ; change to 1.23.2017 when released
Gui, 1:Font
...
IniWrite, v.7.25.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
