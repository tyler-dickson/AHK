...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375 gCherSystemSwitch vCherSystemSwitch, v.6.15.2018   ; Version: change to 1.23.2017 when released
Gui, 1:Font
...
Gui, 1: Tab
Gui, 1:Add, Edit, ReadOnly h60 w300 x0 y390, UPDATE 6/15/2018:`n-Added Docketing SuperEdit. Similar to Calendar Extender.`t`tActivate w/ Control + Space when in an action.`n
...
IniWrite, v.6.15.2018, \\docs-oc\files\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
...
Gui, Add, Button, x65  y192 w30 gAdd1W, +1W
Gui, Add, Button, x97  y192 w30 gAdd2W, +2W
Gui, Add, Button, x129 y192 w30 gAdd3W, +3W
...
::!SRS::
global AttyCert := "\\sea-docs\files\USPTO\Scott.Seeley.epf"
gosub, GetPassword
return

::!TZF::
global AttyCert := "\\docs-oc\files\USPTO\Tomohisa.Fujiwara.epf"
gosub, GetPassword
return

::!RWF::
global AttyCert := "\\docs-sd\files\USPTO\Ryan.Furtado.epf"
gosub, GetPassword
return

::!DMA::
global AttyCert := "\\docs-sd\files\USPTO\Derek.Abeyta.epf"
gosub, GetPassword
return
...
::!ADM::
global AttyCert := "\\docs-sf\files\USPTO\Alejandro.Munoz.epf"
gosub, GetPassword
return

::!AVS::
global AttyCert := "\\docs-sf\files\USPTO\Andrew.Schwaab.epf"
gosub, GetPassword
return
...
::!MHT::
global AttyCert := "\\docs-sf\files\USPTO\Michael.Trenholm.epf"
gosub, GetPassword
return
...
Gui, 2: Add, DateTime, xp+55  y3 w100 vMyMonthCal, %formattedTime%
Gui, 2: Add, Button, x4    y28 	   w33 gAdd1Wnew, +1W
Gui, 2: Add, Button, xp    yp+25   w33 gAdd2Wnew, +2W
Gui, 2: Add, Button, xp    yp+25   w33 gAdd3Wnew, +3W
Gui, 2: Add, Button, xp    yp+50   w33 gAdd1new, +1M
...
Gui, 2: Add, Button, xp    yp+50   w33 h50 gCloseButtonnew, Fast Close
Gui, 2: Font, bold
Gui, 2: Add, Button, xp    y475    w33 h50 gTipsnew, Tips 
Gui, 2: Font,
Gui, 2: Add, Button, x844  y28     w33 gAdd1Wnew, +1W
Gui, 2: Add, Button, xp    yp+25   w33 gAdd2Wnew, +2W
Gui, 2: Add, Button, xp    yp+25   w33 gAdd3Wnew, +3W
Gui, 2: Add, Button, xp    yp+50   w33 gAdd1new, +1M
Gui, 2: Add, Button, xp    yp+25   w33 gAdd2new, +2M
...
;Gui, 2: Font, bold underline s16
;Gui, 2: Add, Text, x0 y300 w225 Center, Tips
;Gui, 2: Font
;Gui, 2: Add, Text, x5 y325 w215, 1) To use, click Edit on the appropriate action, then choose duration.`n`n2) When updating Responsible Atty, press DELETE instead of BACKSPACE.`n`n3) A blank Responsible Atty will give a second prompt to enter. OK to leave blank, but won't auto-save.`n`n4) The Close button at the bottom-right corner doesn't work. Close with X button.
...
if (xpos < xWidth / 2)
	Gui, 2: Show,  x200 w881 yCenter
else
	Gui, 2: Show, x1460 w881 yCenter
...
StringSplit, NewRemarks, OldRemarks, `n,
...
ifinstring, OldActionType, STATUS
	{
...
ie.document.getElementByID("fldstrRemarks").Value := NewRemarks1	
