...
Gui, New, 		  AlwaysOnTop				ToolWindow				, Customize! (New CPI)
...
if (Page.Evaluate("document.getElementById('ctl00_Detail_EditButton_input').value").Value != "")
...
ClickUndo:
Page := ChromeInst.GetPage()
if (Page.Evaluate("document.getElementById('ctl00_Detail_UpdateCancelButton_input').value").Value != "")
	Page.Evaluate("document.getElementById('ctl00_Detail_UpdateCancelButton_input').click()")
Page.Disconnect()
return

ClickCopy:
Page := ChromeInst.GetPage()
if (Page.Evaluate("document.getElementById('ctl00_Detail_CopyButton_input').value").Value != "")
	Page.Evaluate("document.getElementById('ctl00_Detail_CopyButton_input').click()")
Page.Disconnect()
return

ClickFirstRecord:
Page := ChromeInst.GetPage()
Page.Evaluate("document.getElementById('ctl00_Detail_tplNavigator_First').click()")
Page.Disconnect()
return

ClickLastRecord:
Page := ChromeInst.GetPage()
Page.Evaluate("document.getElementById('ctl00_Detail_tplNavigator_Last').click()")
Page.Disconnect()
return

ClickPreviousRecord:
Page := ChromeInst.GetPage()
Page.Evaluate("document.getElementById('ctl00_Detail_tplNavigator_Prev').click()")
Page.Disconnect()
return

ClickNextRecord:
Page := ChromeInst.GetPage()
Page.Evaluate("document.getElementById('ctl00_Detail_tplNavigator_Next').click()")
Page.Disconnect()
return
...
if (Page.Evaluate("document.getElementById('ctl00_Detail_ZoomCtryApp_input').value").Value != "")
	Page.Evaluate("document.getElementById('ctl00_Detail_ZoomCtryApp_input').click()")
else
	Page.Evaluate("document.getElementById('ctl00_Detail_ZoomTrademark_input').click()")
