...
Gui, 1:Font, s6
Gui, 1:Add, Text, x255 h10 y375, v.3.1.2017   ; change to 1.23.2017 when released
Gui, 1:Font
...
Gui, 1:Add, ComboBox,        Sort R20   x8 y273 w90 h16  vHotCornerBL, %HotCornerBL%|| |google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|
Gui, 1:Add, ComboBox,        Sort R20 x201 y246 w90 h16  vHotCornerTR, %HotCornerTR%|| |google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|
Gui, 1:Add, ComboBox,        Sort R20 x201 y273 w90 h16  vHotCornerBR, %HotCornerBR%|| |google.com|calc.exe|iexplore.exe|Kronos|Settings Menu|Paste Clipboard|Copy Clipboard|Date and Initials|Link from Excel|System Switch|Today's Date|
...
;MsgBox, 32, New Updates for 2/21/2017, Hello beta testers!`n`nHere are the changes for today's update:`n`n-Drawers are gone. I decided to scrap them for the Quick Settings menu in the top-left corner, as well as for the Suggested Remarks and Copy/Paste Clipboards. They could break on occasion, and the Suggest/Copy/Paste drawer was too far away for people with wide monitors or >2 monitors. Unusual zoom levels were also a pain to work around. The Quick Settings window will now fade in and out instead.`n`n-Custom Position for Suggested Remarks and Copy/Paste Clipboards. As an off-shoot of the above change, you can now move these three windows to wherever you like. AHK will save the location and it will reappear there the next time. All three use the same shared location. Would you want three separate locations?`n`n-Custom Coloring. You can now select a custom color for the Quick Settings menu and the Suggest/Copy/Paste window. You can find it on the "Enable Store/Paste Extra Clipboards" section. I added a bunch of default colors, but you can enter your own HEX color code (000000 - FFFFFF) if you want something extra custom. A neat little addition that wasn't too hard to implement. The ? next to the selection will take you to a website where you can choose your preferred HEX code.`n`n-Shuffled Hotstrings to the Miscellanous tab. This will check if you have Hotstrings on your desktop. If will also start the script if you try to Add New Hotstring when the script isn't running.`n`n-Removed EFS Pop-out Button from EFS tab. These options will now populate in the Quick Settings menu if they are enabled. Clicking the EFS Options button on the Shortcuts bar will simply open the Quick Settings drawer.`n`n-***NEW***HotCorners Shortcuts. This is similar to SideBar and an off-shoot of my scrapped drawers idea. You can customize the bottom-left, top-right, and bottom-right corners for different functions, just like SideBar. After you set your choice on the third tab of the Settings Menu, simply hold Control and move your mouse to the corners of the screens. This will likely replace SideBar in the future since it has very similar functionality.`n`n-Did anyone try the double-taps with Ctrl-Ctrl and Alt-Alt? Danika experienced some issues. Please let me know if you have any problems. I changed Ctrl-Ctrl to Today's Date and Alt-Alt to Quick Date and Initials for this round of testing.`n`n-I might make this into a tip-of-the-day (week?) thing. I'd make it dismissible for the rest of the day (week?) if you don't want to see it. Does that sound cool? 
return
...
OpenHelp:
		...
		Gui, 13:Font
		Gui, 13:Add, Tab3, Buttons x5 y0 w400 h495 , Quick Date and Initials|System Switch|Settings/Shortcuts Bar|Store/Paste Clipboards|Hyperlink from Excel|Multiuse|EFS Cert Finder/Info Fill/Fee Login|HotCorners|Hotstrings
		...
		Gui, 13:Font
		Gui, 13:Add, Text, x10 y120 w390 +Center +Wrap, Default Keybindings (Certificate and Password Finder - !ATY)`n(EFS Information Filler/EFS Fees Log-in - Settings/Shortcuts Bar or Quick Settings menu.)`n`nEFS Certificate and Password Finder is used when signing into EFS for processing an assigned QC. Typing !ATY will auto-fill the certificate's location, and then find and enter the password into EFS. This is especially useful when the information isn't specifically provided when the QC is assigned.`n`t***This can occasionally fail. Simply try again. If you encounter a missing 2ATY team or incorrect password, email Tyler and it will be updated right away.`n`nInformation Filler will auto-fill the information to access the assigned EFS ID. Open the Quick Settings menu or click the Shortcuts Bar to open the EFS options. Click Fill EFS Info. The screen will jump a bit, and it should fill in the fields.`n`t***This may fail the first time. Access the URL in IE and delete everything from the ? over. Press Enter to reload the page, then try running it again.`n`nEFS Fees Log-in allows you to premptively sign into the EFS Fees system so it won't log you out every fifteen minutes. You can find this option in the Quick Settings menu.`n`t***I suggest running this when starting a QC, or two minutes prior to completing one, so you'll be logged in when you finish and avoid the log-in screen.
		Gui, 13:Add, Button, gExample7, Examples
		
		Gui, 13: Tab, 8
		Gui, 13:Font, bold underline
		Gui, 13:Add, Text, x10 y80 w390 +Center, HotCorners Shortcuts
		Gui, 13:Font
		Gui, 13:Add, Text, x10 y120 w390 +Center +Wrap, Default Keybinding (Hold Control, move mouse to corner of screen.)`n`nHotCorners (formally SideBar) allows the corners of your screens to be customized to run other AHK functions or websites.`n`nThe top-left corner is dedicated to the Quick Settings menu. You can customize the three other corners from the Settings Menu.`n`nDefault options include Calculator, Internet Explorer, Kronos, and Google. You could save WIPO or EPO websites if you'd like.
		;Gui, 13:Add, Button, gExample8, Examples
		Gui, 13:Add, Button, , No examples. Customize options from the Settings Menu.

		Gui, 13: Tab, 9
		Gui, 13:Font, bold underline
		Gui, 13:Add, Text, x10 y80 w390 +Center, Hotstrings
		Gui, 13:Font
		Gui, 13:Add, Text, x10 y120 w390 +Center +Wrap, Default Keybinding (Ctrl + =)`n`nHotstrings are shorthand abbreviations for longer phrases. For example, typing "btw" will auto-expand to "by the way."`n`nThis is technically a separate script, but you can add it to your Desktop and interact with it through the Settings menu. If the Hotstrings.ahk script isn't on your Desktop, the below options will prompt you to add it.`n`na) Start the Hotstrings.ahk script. No need to double-click that script in the morning!`nb) Create a new hotstring. This will open up the Hotstrings interface so a new shorthand can be created.`nc) Correct a Hotstring error. You would use this if you accidentally created an incorrect/annoying hotstring and you want to delete it. Make sure you save the file after you've finished making your corrections.`n`nI highly suggest using an indicator symbol such as !, @, or # in front your hotstrings so you don't activate them on accident.`n`nAdditional Hotstring Examples:`n#ndd -> No new dates docketed.`n#pp -> Previously processed.`n#further -> Per WorkSpace, further instructions already sent.`n#oa -> FA letter reporting an Office Action`; Response due *.`n#sgp -> Statement of Grant of Protection received.
		Gui, 13:Add, Button, gExample9, Examples
...
IniWrite, v3.1.2017, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Version, Version
if CustomColor = Pink
	CustomColor = FF69B4
...
;gosub IndicatorDrawer     ; This is just for the example bouncing drawer. Disable later.
return
...
Gui, 20: Add, Button, x%ScreenWidthPointFive% w%ScreenWidthFourPercent% gInternetExplorer, Open Internet Explorer
...
IniRead, Keystrokes, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, Keystrokes
IniRead, Keystrokes, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, Keystrokes
StringLen, NameLen, Username
StringLen, DateLen, ATDate
KeystrokesSaved := (NameLen + DateLen + 3)
Keystrokes+=%KeystrokesSaved%
IniWrite, %Keystrokes%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, Keystrokes
IniWrite, %Keystrokes%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, Keystrokes
return

RecordDateShortcut:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, DateShortcut, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, DateShortcut
IniRead, DateShortcut, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, DateShortcut
DateShortcut++
IniWrite, %DateShortcut%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, DateShortcut
IniWrite, %DateShortcut%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, DateShortcut
return

RecordAttyFinder:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, AttyFinder, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, AttyFinder
IniRead, AttyFinder, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, AttyFinder
AttyFinder++
IniWrite, %AttyFinder%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, AttyFinder
IniWrite, %AttyFinder%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, AttyFinder
return

RecordCalExtend:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, CalExtend, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, CalExtend
IniRead, CalExtend, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, CalExtend
CalExtend++
IniWrite, %CalExtend%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, CalExtend
IniWrite, %CalExtend%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, CalExtend
return

RecordSysSwitch:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, SysSwitch, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, SysSwitch
IniRead, SysSwitch, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, SysSwitch
SysSwitch++
IniWrite, %SysSwitch%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, SysSwitch
IniWrite, %SysSwitch%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, SysSwitch
return

RecordExcelHLink:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, ExcelHLink, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, ExcelHLink
IniRead, ExcelHLink, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, ExcelHLink
ExcelHLink++
IniWrite, %ExcelHLink%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, ExcelHLink
IniWrite, %ExcelHLink%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, ExcelHLink
return

RecordEFSCertFinder:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, EFSCertFinder, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSCertFinder
IniRead, EFSCertFinder, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSCertFinder
EFSCertFinder++
IniWrite, %EFSCertFinder%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSCertFinder
IniWrite, %KEFSCertFinder%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSCertFinder
return

RecordCopyAction:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, CopyAction, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, CopyAction
IniRead, CopyAction, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, CopyAction
CopyAction++
IniWrite, %CopyAction%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, CopyAction
IniWrite, %CopyAction%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, CopyAction
return

RecordPasteAction:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, PasteAction, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, PasteAction
IniRead, PasteAction, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, PasteAction
PasteAction++
IniWrite, %PasteAction%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, PasteAction
IniWrite, %PasteAction%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, PasteAction
return

RecordSuggestRemarks:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, SuggestRemarks, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, SuggestRemarks
IniRead, SuggestRemarks, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, SuggestRemarks
SuggestRemarks++
IniWrite, %SuggestRemarks%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, SuggestRemarks
IniWrite, %SuggestRemarks%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, SuggestRemarks
return

RecordClientCodeIE:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, ClientCodeIE, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, ClientCodeIE
IniRead, ClientCodeIE, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, ClientCodeIE
ClientCodeIE++
IniWrite, %ClientCodeIE%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, ClientCodeIE
IniWrite, %ClientCodeIE%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, ClientCodeIE
return

RecordEFSFill:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, EFSFill, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSFill
IniRead, EFSFill, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSFill
EFSFill++
IniWrite, %EFSFill%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSFill
IniWrite, %EFSFill%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSFill
return

RecordEFSLogin:
formattime, ThisHour, , MM.dd.yyyy-htt
IniRead, EFSLogin, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSLogin
IniRead, EFSLogin, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSLogin
EFSLogin++
IniWrite, %EFSLogin%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\%Computername%.ini, Achievements, EFSLogin
IniWrite, %EFSLogin%, H:\Docketing\AutoHotKey\.ini Files - DO NOT TOUCH!\ImageSearch\Hourly\%ThisHour%\%Computername%-%ThisHour%.ini, Achievements, EFSLogin
return
